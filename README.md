...
**[Atlas — Workflow Orchestration Platform](https://github.com/OriolJT/atlas)**
Multi-tenant distributed platform for durable workflow orchestration with saga-based execution, compensation, and dead-letter handling. 5 services (Java 25, Spring Boot 4), PostgreSQL, Kafka (KRaft), Redis, gRPC, React admin console. Outbox pattern, lease-based crash recovery, three-pillar observability (Prometheus, Grafana, Tempo), Kubernetes manifests, and full integration test suite with Testcontainers.
...
| **Frameworks** | Spring Boot, Quarkus, Hibernate/JPA, JUnit 5, gRPC/Protobuf |
| **Infrastructure** | Docker, Kubernetes, Kafka, Keycloak, Jenkins, GitHub Actions, CI/CD |
| **Databases** | PostgreSQL, MariaDB, Redis |
| **Architecture** | Distributed systems, workflow orchestration, event-driven sagas, multi-tenancy, SSO/auth design, REST APIs |

---

### Contact

- [LinkedIn](https://linkedin.com/in/orioljt)
- orioljt5@gmail.com
